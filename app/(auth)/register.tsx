...
export default function RegisterScreen() {
  ...
  const handleSubmit = () => {
    ...
    if (!accepted) {
      nextErrors.terms = "Please accept the Terms & Service.";
    }
  ...
  const handlePasswordChange = (value: string) => {
    ...
    setErrors((prev) => ({
      ...
      confirm:
        confirm.length > 0 && value === confirm ? undefined : prev.confirm,
    }));
  };
  ...
  const handleConfirmChange = (value: string) => {
    ...
    setErrors((prev) => ({
      ...prev,
      confirm:
        value === password && value.length > 0 ? undefined : prev.confirm,
    }));
  };
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Text style={[styles.segmentText, { color: palette.onPrimary }]}>
                Register
              </Text>
            </Pressable>
            <Pressable
            ...
            >
              <Text style={[styles.segmentText, { color: palette.textMuted }]}>
                Login
              </Text>
            </Pressable>
          </View>
          ...
          <View style={styles.formSection}>
            <Text style={[styles.label, inputLabelColor]}>
              Confirm Password
            </Text>
            <View
              style={[
          ...
          <Pressable onPress={handleToggleAccepted} style={styles.termsRow}>
            <View
              style={[
                styles.checkbox,
                {
            ...
            <Text style={[styles.termsLink, { color: palette.accent }]}>
              Terms & Service
            </Text>
          </Pressable>
          {errors.terms ? (
